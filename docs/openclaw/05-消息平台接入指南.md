...
> **v2026.6.1 新增注意**：Telegram、WhatsApp、iMessage、Slack、Discord、Microsoft Teams、Google Chat、Google Meet 和 iOS realtime Talk 的通道稳定性继续增强；发送、重试、队列、线程和 stream 相关排障要优先查 transcript、Gateway 日志、Control UI Activity 与 channel-specific 状态。下面各平台章节会按“先接入、再确认新版行为”的顺序讲。
