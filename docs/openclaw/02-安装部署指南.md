...
> **2026-04 差量更新**
>
> - 官方当前最快路径是 `macOS / Linux / WSL2` 下执行 `curl -fsSL https://openclaw.ai/install.sh | bash`
> - **Node.js 24.x 推荐，22.14+ 兼容**
> - Windows 原生支持没有取消，但官方仍注明 **WSL2 更稳定**
> - 手动安装方式依然有效，这篇指南保留它们，方便开发和运维场景
> - **版本号**：下文若出现 `openclaw@具体版本` 或固定 Docker tag，多为历史示例；**稳定版参考**为 README 徽章 **v2026.3.28**，**当前推荐线**以你执行安装时 npm / 镜像站展示的 **`latest`、官方 [Releases](https://github.com/openclaw/openclaw/releases)（含预发布）** 及 **`openclaw --version`** 为准，不要机械照抄旧版本号。
