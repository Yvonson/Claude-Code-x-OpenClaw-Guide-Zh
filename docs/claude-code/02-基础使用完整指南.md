...
- `/review` 已弃用，官方建议改装 `code-review@claude-plugins-official`；`/vim` 已在 v2.1.92 移除，编辑模式改由 `/config` 控制。
...
# 显示最近的版本更新
Release Notes v2.1.92
=====================
- Added: /plan and planning-first workflow entry
- Added: /plugin marketplace management improvements
- Improved: session rewind, insights, statusline, schedule tooling
- Fixed: MCP and hook stability issues
```
